    ...
    <Container>
      ...
      <div className="flex flex-col md:flex-row my-10 gap-16">
        ...
        <div className="flex flex-col md:w-2/4 gap-6 text-gray-600">
          <p>
            Welcome to ShopWear, where style meets quality. Our mission is to
          ...
          <p>
            At ShopWear, we prioritize your satisfaction. From the moment you
            ...
            choosing ShopWear. We’re excited to be a part of your style journey.
          </p>
          <p className="text-gray-800 font-extrabold">Our Mission</p>
          <p>
            At ShopWear, our mission is to empower you to express your unique
          ...
          <p>
            At ShopWear, our vision is to be a global fashion leader, known for
            cutting-edge style and quality. We aim to inspire confidence and
            creativity, making ShopWear the go-to choice for individual
            expression.
          </p>
        </div>
      </div>
      ...
      <div className="mb-20 flex flex-col md:flex-row text-sm">
        <div className="flex flex-col px-10 md:px-16 py-8 sm:py-20 border-[0.063rem] border-gray-200 gap-5">
          ...
          <p>
            At ShopWear, quality comes first. Every product is carefully chosen
        ...
        <div className="flex flex-col px-10 md:px-16 py-8 sm:py-20 border-[0.063rem] border-gray-200 gap-5">
          <p>Convenience</p>
          <p>
            ShopWear ensures a smooth shopping experience with easy browsing,
        ...
        <div className="flex flex-col px-10 md:px-16 py-8 sm:py-20 border-[0.063rem] border-gray-200 gap-5">
          ...
          <p>
            At ShopWear, exceptional service is our promise. Our dedicated
